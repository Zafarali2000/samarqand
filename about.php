...
<div class="mySlides fade">
    ...
    <div class="textrasm">DASTURCHILAR XONASI</div>
</div>
...
<div class="mySlides fade">
    ...
    <div class="textrasm">DARS JARAYONI</div>
</div> 
...
<div class="containercon">
        <div class="section-title">
            <h1>Veb sayt yaratuvchisi haqida ma'lumot</h1>
        </div>
...
<div class="swiper reviews-slider">
   ...
   <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <b  class="foydalanuvchiend">Saytni yaratishdan maqsad</b><br>
            Veb saytni yaratishdan asosiy maqsadlardan biri O'zbekistondagi tarixiy obidalarlarni dunyoga tanitishdir. Samarqand viloyatidagi tarixiy obidalar haqida ko'proq ma'lumot berish muhumdir. Bizga tarixdan ma'lumki bu diyorda juda ham ko'p yetuk allomalar yashab o'tgan.  Ajdodlarimizning qilgan ishlari tanitish maqsadida va dunyoga tarixiy obidalar haqida ma'lumot berishga qaratilgan.</p>
            <h2 class="readread1"><a href="menhaqimda.php">Ko'proq ma'lumot <i class="fa-solid fa-arrow-right fa-fade"></i></a></h2>
      ...
      <div class="swiper-slide slide">
         ...
         <p>
           ...
           <b class="kasb">Kompyuter Injiniring</b><br>
           <b class="ismsharif">Zafarali Daminov Xusanovich</b><br>
           Muhammad al-Xorazmiy nomidagi Toshkent Axborot Texnologiyalari Universiteti Samarqand filiali "Kompyuter injiniring" fakultet talabsi.
         </p>
      ...
      <div class="swiper-slide slide">
         <p class="foydalanuvchi">
            <b class="foydalanuvchiext">Veb saytning muhimligi</b><br>
            Tarixiy obidalarga bag'ishlangan veb-sayt ishi juda dolzarbdir, chunki tarixiy yodgorliklar umumiy madaniy merosimiz haqida tushuncha beradigan muhim madaniy yodgorliklardir. Tarixiy obidalar haqida ma’lumot berib, ularni asrab-avaylashni rag‘batlantirish orqali ushbu saytlarga bag‘ishlangan veb-saytlar kelajak avlodlar ulardan o‘rganishda davom etishiga yordam beradi.</p>
            <h2 class="readread1"> <a href="menhaqimda.php">Ko'proq ma'lumot <i class="fa-solid fa-arrow-right fa-fade"></i></a></h2>
      </div>
...
<section class="reviews">
   ...
   <h1 class="heading">Foydalanuvchilarning izohlari</h1>
